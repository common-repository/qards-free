...
$_qards_config['DM_UPGRADE_URL'] = 'https://designmodo.com/';
$_qards_config['DM_RENEW_LICENSE_URL'] = 'https://designmodo.com/my-account';
...
$_qards_config['DM_PLUGIN_VERSION'] = '1.5.3';
$_qards_config['DM_POST_TYPE'] = 'qards_page';
$_qards_config['DM_UNRELATED_COMPONENT_MAX_AGE'] = (60 * 60 * 5); // 5h
$_qards_config['DM_MIN_PHP_VERSION'] = '5.6.0';
